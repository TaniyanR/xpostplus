...
$isCurrent = static function (string $path) use ($currentPath): string {
    if ($path === '/') {
        return rtrim($currentPath, '/') === '' ? ' current' : '';
    }
